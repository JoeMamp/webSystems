...
//
// The Add is done below.  Go ahead and finish the remianing functions.
...
// Can be done without the if statements using switch(true)
switch(true) {
  case isset($_POST['add']) && $_POST['add'] == 'Add':
    $op = new Addition($o1, $o2);
    break;
  case isset($_POST['sub']) && $_POST['sub'] == 'Subtract':
    $op = new Subtraction($o1, $o2);
    break;
  case isset($_POST['mult']) && $_POST['mult'] == 'Multiply':
    $op = new Multiplication($o1, $o2);
    break;
  case isset($_POST['div']) && $_POST['div'] == 'Divide':
    $op = new Division($o1, $o2);
    break;
}
...
<body class="card">
  ...
  <div class="card text-center">
    ...
    <img src="https://pbs.twimg.com/media/Cr2kZMuUkAAuLbM?format=jpg&name=4096x4096" class="card-img-top img-responsive col-md-12">
    <form class="card-body" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> <!-- form validation -->
